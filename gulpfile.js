...
function helpSprite() {
  return gulp.src('./assets/icons/help/*.svg').pipe(svgstore()).pipe(gulp.dest('./assets/icons/'));
}

function miscSprite() {
  return gulp.src('./assets/icons/misc/*.svg').pipe(svgstore()).pipe(gulp.dest('./assets/icons'));
}

function copyAssets() {
  return gulp
    .src(['assets/fonts/**/*', 'assets/icons/*.svg', 'assets/*.json', 'assets/*.webp'], {
      base: './assets',
    })
    .pipe(gulp.dest('./build/assets/'));
}
...
function copyScripts() {
  return gulp.src('./pages/**/*.js', { base: './pages' }).pipe(gulp.dest('./build/pages/'));
}
...
exports.build = series(clean, images, parallel(copyAssets, scssBuild, minifyHTML, copyScripts));
